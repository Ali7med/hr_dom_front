...
export const settingsTabs: SettingsTab[] = [
  ...
  { name: 'releases', key: 'nav.releases', icon: 'pi pi-megaphone', permission: 'releases.manage' },
  ...
  // إعدادات الحساب (تغيير كلمة المرور/الإيميل) — خدمة ذاتية (بلا صلاحية)، تُبقى قرب النهاية.
  { name: 'account', key: 'nav.account', icon: 'pi pi-user' },
]
